...
-- Ordenação descrescente através do alfabeto 
 ...
 -- COLLATION
 -- _ai_ - Ignora acentuação do texto
 -- _ci_ - Ignora formatação do texto, se a letra está em maiúsculo ou minúsculo
 -- Caso esteja _as_ ou _cs_ exige acentuação/maiúsculo e minúsculo --
